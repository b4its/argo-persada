...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pesanan', function (Blueprint $table) {
            ...
            // Metode pembayaran 
            $table->tinyInteger('metode_pembayaran_rilis_dana')->default(0)->comment("0. belum ditentukan, 1. Tunai, 2. Kredit"); 
            $table->tinyInteger('metode_pembayaran_lunas')->default(0)->comment("0. belum ditentukan, 1. Tunai, 2. Kredit"); 
